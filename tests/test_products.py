...
def client():
    with TestClient(app) as test_client:
        ...
        # If the user already exists from an earlier test database,
        # that's okay. We only need the login to succeed.
